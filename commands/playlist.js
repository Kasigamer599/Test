...
module.exports = {
    info: {
        name: "playlist",
        description: "<:dr_heart:817449378792472636> To play songs with paylist <:dr_heart:817449378792472636>",
    ...
    run: async function (client, message, args) {
      ...
      loop: false
        ...
        async function play(guild, song) {
            ...
            const dispatcher = serverQueue.connection.play(ytdl(song.url, { quality: "highestaudio", highWaterMark: 1 << 100, type: "opus" })).on("finish", () => {
