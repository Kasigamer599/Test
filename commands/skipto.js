...
module.exports = {
  info: {
    name: "skipto",
    description: "<:enjoy:813458536741732432> Skip to the selected queue number <:enjoy:813458536741732432>",
    usage: "skipto <number>",
    aliases: ["st"]
  },
    ...
    queue.textChannel
      .send({
        embed: {
          ...
          description: `${
            message.author
          }  skipped \`${args[0] - 1}\` songs`
        }
      })
      .catch(console.error);
    message.react("<:enjoy:813458536741732432>");
  }
};
